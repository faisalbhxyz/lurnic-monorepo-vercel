...
const CertificateSettingsSchema = z
  .object({
    ...
    brand_logo: z.any().optional().nullable(),
    watermark_image: z.any().optional().nullable(),
    watermark_opacity: z.coerce.number().min(0).max(100).optional().nullable(),
    organization_name: z.string().optional().nullable(),
    signer_name: z.string().optional().nullable(),
    signer_role: z.string().optional().nullable(),
    signer_org: z.string().optional().nullable(),
    dual_signers_enabled: z.boolean().optional().nullable(),
    signer2_name: z.string().optional().nullable(),
    signer2_role: z.string().optional().nullable(),
    signer2_org: z.string().optional().nullable(),
